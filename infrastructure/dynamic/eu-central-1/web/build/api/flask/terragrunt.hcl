locals {
  ...
  # Get commit hash
  commit_hash = run_cmd("${get_parent_terragrunt_dir()}/modules/scripts/get_commit_hash.sh", local.global_replacements.REPO_SSH, local.global_replacements.BRANCH)
...
terraform {
  source = "${get_parent_terragrunt_dir()}/modules/terraform-aws-codebuild"
